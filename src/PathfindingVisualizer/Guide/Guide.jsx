...
import start from "../Node/images/start.svg"; // Tell webpack this JS file uses this image
import end from "../Node/images/end.svg";
	...
	render() {
		return (
			<div className="PopUpTextBox">
				<header>
					<p>Welcome to Dijkstra's Search Visualizer</p>
				...
				<div className="PopUpIntroductionText">
					...
					<div className="player">
						...
						<div
							style={{
								backgroundColor: "rgba(185, 158, 201, .75)",
							}}
							name="wall"
						></div>
