...
//Performs algorithm and returns all nodes in the order they were visited. 
//Nodes point back to their previous node
//This allows the shortest path to be computed by backtracking from the end node.
